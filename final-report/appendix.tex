...
\subsection*{Appendix A: System Screenshots}

\renewcommand{\thefigure}{A.\arabic{figure}}
\setcounter{figure}{0}

The following figures present screenshots of the fully implemented StudyBug system.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{img/imagin.png}
    \caption{StudyBug Dashboard --- Main Interface Showing XP, Streaks, and Learning Progress}
    \label{fig:A1}
\end{figure}
...
status & VARCHAR & Session state: IN\_PROGRESS, COMPLETED, or CANCELLED \\
