\chapter{System Design and Architecture}
    ...
    \begin{itemize}
        ...
        \item \textbf{Application Layer}: Node.js/Express.js RESTful API server
        \item \textbf{Data Layer}: PostgreSQL database with Supabase authentication
    \end{itemize}
    ...
    \begin{table}[H]
    \centering
    \begin{tabular}{|p{3cm}|p{3.2cm}|c|p{5cm}|}
    \hline
