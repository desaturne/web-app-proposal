     \chapter{Introduction}
        ...
        The major scope of the project is to assist students in developing effective study habits. The proposed system will be able to provide:
        \begin{itemize}
            \item Study scheduling and task planning
            \item Focus timer functionality for structured study sessions
            \item Progress tracking to monitor study consistency
            \item Aesthetic UI design to improve motivation and user engagement
        \end{itemize}
        \section{Report Organization}
            \subsection{Introduction}
                The main purpose of the introduction is to set the scene for readers so that they can understand the problems that students face during studying and how the proposed StudyBug system aims to help them. 
            \subsection{Literature Review}
                The literature review is there to familiarize ourselves with the current state of knowledge on study productivity tools and ensure that the proposed solution addresses gaps not covered by existing applications. 
            ...
            \subsection{Requirement Analysis}
                It gives us a clear vision about the necessary programming languages and software required to build the StudyBug web application. 
            ...
            \subsection{Expected Outcome}
                It helps to define the anticipated results of the project and ensures that the development stays aligned with the set goals.
